...
public class CaveSurfaceFeature extends Feature<CaveSurfaceFeatureConfig> {
    ...
    public boolean generate(FeatureContext<CaveSurfaceFeatureConfig> context) {
        ...
        boolean onlyOnBaseStoneOverworld = config.onlyOnSoulSandAndSoil();
    ...
    private boolean useBaseStoneOverworld(boolean onlyOnSoulSandAndSoil, BlockState blockState) {
        if (onlyOnSoulSandAndSoil == false) {
            return true;
        }
