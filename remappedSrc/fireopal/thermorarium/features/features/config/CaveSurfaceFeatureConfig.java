...
public record CaveSurfaceFeatureConfig(IntProvider size, int offset, BlockState blockState, float chance, boolean onSpecificBlockState, IntProvider amountOfCircles, BlockState targetBlock, boolean onlyOnSoulSandAndSoil, boolean generateManyCircles) implements FeatureConfig {
    public static final Codec<CaveSurfaceFeatureConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
       ...
       BlockState.CODEC.fieldOf("targetBlock").forGetter(CaveSurfaceFeatureConfig::targetBlock),
       Codec.BOOL.fieldOf("onlyOnSoulSandAndSoil").forGetter(CaveSurfaceFeatureConfig::onlyOnSoulSandAndSoil),
